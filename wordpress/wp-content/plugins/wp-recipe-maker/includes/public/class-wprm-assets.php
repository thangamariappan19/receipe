...
class WPRM_Assets {
	...
	public static function get_custom_css( $type = 'recipe' ) {
		...
		$output .= ' .wprm-comment-ratings-container svg [id="wprm-star-full"] { fill: ' . WPRM_Settings::get( 'template_color_comment_rating' ) . '; }';
		$output .= ' .wprm-comment-ratings-container svg [id="wprm-star-empty"] { stroke: ' . WPRM_Settings::get( 'template_color_comment_rating' ) . '; }';
