...
class WPRM_SC_Jump_Video extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		$output = '<a href="#wprm-recipe-video-container-' . esc_attr( $recipe->id() ) . '" style="' . $style . '" class="' . implode( ' ', $classes ) . '"' . $smooth_scroll_speed . '>' . $icon . __( $atts['text'], 'wp-recipe-maker' ) . '</a>';
